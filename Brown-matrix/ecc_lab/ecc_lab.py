...
# Ungraded
def roundtrip(s, probability):
    c = G*bits2mat(str2bits(s))
    e = noise(c, probability)
    ce = c + e
    print(s)
    print(bits2str(mat2bits(R*ce)))
    print(bits2str(mat2bits(R*correct(ce))))
